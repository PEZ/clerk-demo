...
return (new CustomEvent(event_name,(function (){var obj40436 = {"detail":data};
return obj40436;
})()));
} else {
...
var f = (function (){var pred__40443 = cljs.core._EQ_;
var expr__40444 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__40443.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__40444))){
return ((function (pred__40443,expr__40444){
return (function (p1__40437_SHARP_){
return console.warn(p1__40437_SHARP_);
});
;})(pred__40443,expr__40444))
} else {
if(cljs.core.truth_(pred__40443.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__40444))){
return ((function (pred__40443,expr__40444){
return (function (p1__40438_SHARP_){
return console.debug(p1__40438_SHARP_);
});
;})(pred__40443,expr__40444))
} else {
if(cljs.core.truth_(pred__40443.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__40444))){
return ((function (pred__40443,expr__40444){
return (function (p1__40439_SHARP_){
return console.error(p1__40439_SHARP_);
});
;})(pred__40443,expr__40444))
} else {
return ((function (pred__40443,expr__40444){
return (function (p1__40440_SHARP_){
return console.log(p1__40440_SHARP_);
});
;})(pred__40443,expr__40444))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__40447){
...
var opts = map__40448__$1;
var eval_fn = cljs.core.get.call(null,map__40448__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__40450_SHARP_);
});})(new_def))
);
...
return (function (p__40451){
var vec__40452 = p__40451;
var ky = cljs.core.nth.call(null,vec__40452,(0),null);
var v = cljs.core.nth.call(null,vec__40452,(1),null);
...
}catch (e40457){if((e40457 instanceof Error)){
var e = e40457;
return not_found;
} else {
throw e40457;
...
//# sourceMappingURL=utils.js.map?rel=1540243373762
